...
if ! mpirun lmp -var configfile /home/ndv3235/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/n480/kalj_n480_create.lmp -var id 1 -in /home/ndv3235/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/create_3d_binary.lmp; then
...
for T in "${temperatures[@]}"; do
    if ! mpirun lmp -var configfile /home/ndv3235/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/n480/kalj_n480_T$T.lmp -var id 1 -in /home/ndv3235/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/anneal_3d_binary.lmp; then
