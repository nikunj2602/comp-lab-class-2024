#!/bin/bash
#SBATCH --job-name=kalj_production_n360
#SBATCH --ntasks-per-node=4
#SBATCH --cpus-per-task=1
#SBATCH --time=00:20:00  # 3 times shorter than equilibration
#SBATCH --output=output_production_n360.log
...
for T in "${temperatures[@]}"; do
    if ! mpirun lmp -var configfile /home/ndv3235/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/n360/kalj_n360_T$T.lmp -var id 1 -in /home/ndv3235/comp-lab-class-2024/Week9-LAMMPS-SupercooledLiquids/Inputs/production_3d_binary.lmp; then
