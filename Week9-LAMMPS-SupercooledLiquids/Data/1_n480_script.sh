...
# System creation
mpirun lmp -var configfile ../n480/kalj_n480_create.lmp -var id 1 -in ../create_3d_binary.lmp
...
for T in "${temperatures[@]}"; do
    mpirun lmp -var configfile ../n480/kalj_n480_T$T.lmp -var id 1 -in ../anneal_3d_binary.lmp
done